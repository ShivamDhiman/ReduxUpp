...
function Forms() {
  ...
  // Todo It should be fixed from backed and then remove it//
  // let usedPediatricCount =
  //   (cdeSummary.Pediatric?.usedCDECount &&
  //     cdeSummary.Pediatric?.usedCDECount > cdeSummary.Pediatric?.studyCDECount &&
  //     cdeSummary.Pediatric?.studyCDECount) ||
  //   (cdeSummary.Pediatric?.usedCDECount &&
  //     cdeSummary.Pediatric?.usedCDECount <= cdeSummary.Pediatric?.studyCDECount &&
  //     cdeSummary.Pediatric?.usedCDECount) ||
  //   '0';
  // let usedAdultCount =
  //   (cdeSummary.Adult?.usedCDECount &&
  //     cdeSummary.Adult?.usedCDECount > cdeSummary.Adult?.studyCDECount &&
  //     cdeSummary.Adult?.studyCDECount) ||
  //   (cdeSummary.Adult?.usedCDECount &&
  //     cdeSummary.Adult?.usedCDECount <= cdeSummary.Adult?.studyCDECount &&
  //     cdeSummary.Adult?.usedCDECount) ||
  //   '0';
        ...
        <div className="col-8 d-flex justify-content-end ">
          <div className="d-flex me-2 col-4 justify-content-end">
            ...
            <div className={`${styles.PediatricCDEs}`}>
              ...
              {/* {usedPediatricCount}
              {''} of {cdeSummary.Pediatric?.studyCDECount || '0'} */}
            </div>
          </div>
          <div className="d-flex col-4 justify-content-center">
            ...
            <div className={`${styles.PediatricCDEs}`}>
              ...
              {/* {usedAdultCount}
              {''} of {cdeSummary.Adult?.studyCDECount || '0'} */}
            </div>
          </div>
        </div>
        <div className="col-2">
