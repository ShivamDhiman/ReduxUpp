...
const AddEditComponent = dynamic(() => import('../../src/components/StudySetting/TemplateForm'), {
...
const TemplateForm = (props) => {
  ...
  return (
    <Layout title={`Study Setting | RADxUP.`} data={{ layoutType: 'HOME' }} description={`RADxUp Study Setting`}>
...
TemplateForm.getInitialProps = async ({ store, query, isServer, pathname }) => {
  const pageName = query && query.id ? query.id : '';
